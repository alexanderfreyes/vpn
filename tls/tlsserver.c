...
int main(){
  ...
  SSL_CTX_use_certificate_file(ctx, "./cert_server/modelCA_cert.pem", SSL_FILETYPE_PEM);
  SSL_CTX_use_PrivateKey_file(ctx, "./cert_server/modelCA_key.pem", SSL_FILETYPE_PEM);
